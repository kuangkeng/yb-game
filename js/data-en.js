var dataset = [
	[
		{
			"id":"scenario-0",
			"text":"<p>The election is just around the corner. It’s all you and your collegemates are talking about!<br>Having just turned 18, it’ll be your first time voting. You cannot be more excited to exercise your right as a citizen.</p>",
		...
		},
		{
			...
			"img":"../img/story-0/1.png",
			"more":1,
			"info":"<p>Have you heard of Groupthink Bias or Social Bubble?<br>Groupthink is when you find yourself forming opinions based on what the majority thinks, or not wanting to disagree with them.<br>A Social bubble is when you find yourself mostly conversing with a select group of people who usually share them same views as you, leading to an echo chamber when you are not exposed to other point of views.</p>",
			"optNum":0,
			"optImg":0,
		...
		{
			"id":"scenario-0_3",
			"text":"<p>You watch the latest videos the candidate recently uploaded.<br>In it, Siti Yasmin warns her followers and constituents against voting for her rival, a veteran politico and seat incumbent S.Jega, who she claims is very conservative and traditional. Voting for him, she warns, can result in a lack of freedom and rights for today’s youth.</p>",
			"img":"../img/story-0/2.png",
			"more":0,
			"info":"",
			"optNum":0,
		...
		},
		{
			...
			"more":1,
			"info":"<p>Introducing the Halo/Horn Effect<br>Almost all of us are guilty of making snap judgements against someone, causing us to like/not like them.<br>The halo effect is a bias that causes us to like a person based on one believed positive trait while ignoring all the bad. The horn effect is the opposite, where we view a person negatively based on one perceived bad trait/stereotype. This could lead us to ignore any good trait that person might have.<br>An example of this is assuming good-looking people are competent, young people as progressive, or certain groups of people are lazy.</p>",
			"optNum":0,
			"optImg":1,
			"opt0":"Next",
		...
		{
			"id":"scenario-A_2",
			"text":"<p>Come election day, you're about to head to your polling station when you receive a text message.<br>A classmate tells you about a rumour he's heard about the rival candidate, but thinks the latter is being framed.</p>",
		...
		{
			"id":"scenario-A1_1",
			"text":"<p>You end up voting for Yasmin, your TikTok politico candidate.<br>Not long after, to your dismay, she begins backtracking on all her pledges and, worse, goes after critics, including your friends, and tries to silence them!</p>",
		...
		},	
		{
			...
			"img":"../img/story-0/12.png",
			"more":1,
			"info":"<p>Uh-oh, Cybertroopers<br>Cybertroopers are people who are paid to spread political propaganda/ fake news on the internet and attack specific people online.</p>",
			"optNum":0,
			"optImg":1,
			"opt0":"Hmm...",
		...
		},
		{
			...
			"img":"../img/story-0/18.png",
			"more":1,
			"info":"<p>Don't be fooled by racial politics!<br>Racial or extreme politics is the use of race or other issues by politicos to divide voters or the public.<br>This is used by politicians to pit one race/group against another for their political gain, or to distract from other issues.</p>",
			"optNum":0,
			"optImg":1,
		...
		},
		{
			...
			"img":"../img/story-0/18.png",
			"more":1,
			"info":"<p>Infobox: Did you hear about False Dichotomy/False Binary?<br>Sometimes called the 'either/or' thinking, it's when a person is presented with just two choices/ sides when in fact, there are often more sides/options to choose from.<br>For example, a person might tell you that if you disagree with one government policy, you are against the whole government, or if you disagree with one woman candidate, you are an anti-feminist.</p>",
			"optNum":0,
			"optImg":0,
