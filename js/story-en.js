...
function tweet() {
  ...
  tweet_url += '&url=https://choicesimake.com&via=milemsia&hashtags=MediaLiteracy';
  window.open(tweet_url,'_blank');
}

function whatsapp(){
  var whatsapp_msg = "This role-playing game by MILE really opened my eyes to the #Covid19 infomedic. Plus, it’s quick and fun. Just pick a character and go!"
